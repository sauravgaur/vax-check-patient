...
export class Wizard2Component implements OnInit, AfterViewInit {
    ...
    ngOnInit() {
        ...
        //     lotNumber1: new FormControl('sdfsdf'),
        //     lotNumber2: new FormControl('asdff'),
        // });
    ...
    async onFileSelect(file) {
        ...
        const existingSuppliment = null; //this.loginResponse.media.find((x: any) => x.document_type === 'SUPPLEMENT_DOC');
    ...
    async updateImageSrc(data) {
        ...
        const existingVaxCard = null; //this.loginResponse.media.find((x: any) => x.document_type === 'VAX_CARD');
        if (this.srcPath) {
    ...
    async updateWebcamImage(data) {
        ...
        this.webcamURL = this.wizardService.findFilePath(this.media, 'VAX_CARD');
        this.cd.markForCheck();
    }
